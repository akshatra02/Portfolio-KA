      ...
      <main>
        ...
        <section id="contact" className={styles.contact}>
          ...
          <ul className={styles.cicon}>
            <li>
            <a
              href="mailto:kungumaakshatra@gmail.com" target="_blank"
...
<li>
            <a href="https://github.com/akshatra02" target="_blank" title="akshatra02">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <li>
            <a href="https://www.linkedin.com/in/kunguma-akshatra-m/" target="_blank" title="kunguma-akshatra-m">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
      ...
      <footer className={styles.foot} >
        ...
        <a className={styles.top} href="#nav"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-short" viewBox="0 0 16 16">
